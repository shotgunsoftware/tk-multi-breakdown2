...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalLayout_3.addWidget(self.group_by_label)
        self.group_by_combo_box = QtGui.QComboBox(self.toolbar_widget)
        self.group_by_combo_box.setObjectName("group_by_combo_box")
        self.horizontalLayout_3.addWidget(self.group_by_combo_box)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.refresh_button = QtGui.QToolButton(self.toolbar_widget)
        self.refresh_button.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/tk-multi-breakdown2/icons/main-outofdate@2x.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/tk-multi-breakdown2/icons/mode_switch_thumb.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/tk-multi-breakdown2/icons/mode_switch_thumb_active.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.thumbnail_view_btn.setIcon(icon1)
        ...
        self.horizontalLayout_3.addWidget(self.thumbnail_view_btn)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/tk-multi-breakdown2/icons/mode_switch_card.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap(":/tk-multi-breakdown2/icons/mode_switch_card_active.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.list_view_btn.setIcon(icon2)
        self.list_view_btn.setCheckable(True)
        self.list_view_btn.setAutoRaise(False)
        self.list_view_btn.setObjectName("list_view_btn")
        self.horizontalLayout_3.addWidget(self.list_view_btn)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/tk-multi-breakdown2/icons/grid-inactive.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap(":/tk-multi-breakdown2/icons/grid-active.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.grid_view_btn.setIcon(icon3)
        self.grid_view_btn.setCheckable(True)
        self.grid_view_btn.setAutoRaise(False)
        self.grid_view_btn.setObjectName("grid_view_btn")
        self.horizontalLayout_3.addWidget(self.grid_view_btn)
        ...
        self.header_layout.addLayout(self.horizontalLayout_3)
